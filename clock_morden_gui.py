...
def default_home():
    ...
    time_text = Label(root,font=("century gothic",30),fg=fgColor,bg=bgColor)
    time_text.place(x=258,y=170)#x258

    date_text = Label(root,text=date+" | ",fg=fgColor,bg=bgColor,font=("century gothic",28))
    date_text.place(x=138,y=171)#x138

    tod = Label(text='DAY',font=("century gothic",8),fg=fgColor,bg=bgColor)
    tod.place(x=165,y=214)

    hour = Label(text='Hour',font=("century gothic",8),fg=fgColor,bg=bgColor)
...
def stopwatch():
    ...
    stopwatch_label = Label(text='00:00:00',font=("century gothic",30),fg=fgColor,bg=bgColor)
...
def toggle_win():
    ...
    def bttn(x,y,text,bcolor,fcolor,cmd):
        ...
        myButton1 = Button(f1,text=text,width=23,height=2,fg=bgColor,border=0,bg=fcolor,activeforeground=bgColor,activebackground=bcolor,            command=cmd)
    ...
    def dele():
        f1.destroy()
        b2 = Button(root,text='=',font=("century gothic",12),border=0,command=toggle_win,bg='#12c4c0',activebackground='#12c4c0')
        b2.place(x=5,y=10)

    Button(f1,text='x',font=("century gothic",12),border=0,command=dele,bg='#12c4c0',activebackground='#12c4c0').place(x=5,y=10)
    
default_home()

global b2
b2=Button(root,text='=',font=("century gothic",12),border=0,command=toggle_win,bg='#12c4c0',activebackground='#12c4c0').place(x=5,y=10)

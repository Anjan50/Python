...
print("Length of list using while loop: ",
      length1(l.copy()))  # using copy to avoid changing original list

# using recusion to find length
print("Length of list using recusion: ",
      length2(l.copy()))  # using copy to avoid changing original list

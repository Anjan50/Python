...
data = pd.read_csv(
    'https://trello-attachments.s3.amazonaws.com/5f083c31f5989959af0a86e1/5f083c4b69aef3831672e7b4/c7d1b1f0414ab051c629f08775b54e2f/Housing_Modified_prepared.csv'
)
...
for i in range(len(independent_variabels)):
    vif_list = [
        vif(data[independent_variabels].values, index)
        for index in range(len(independent_variabels))
    ]
    mvif = max(vif_list)
